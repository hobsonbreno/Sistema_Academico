...
# Para empurrar o código para o github digite:
git push 
# Para empurrar o código para todas as branches do github digite:
git push --all # dessa forma sobe para todas as branches criadas no github